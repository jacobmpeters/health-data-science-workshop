...
`aspiR` was started by a group of like-minded health data professionals that aspire to write better R code. R programmers at **ANY skill-level** are welcome to attend or contribute to a workshop or tutorial.
